...
export default {
  ...
  mounted() {
    ...
    this.filterInfo.options = this.columns
      .filter((item, index) => index > 0 && index < this.columns.length - 1)
      .map(item => ({
        value: item.prop,
        label: item.label
      }));
  ...
  data() {
    return {
      columns: [
        ...
        { prop: "dataName", label: "数据名称", width: 170, align: "center" },
        { prop: "countyCode", label: "区县代码", width: 170, align: "center" },
        { prop: "countyName", label: "区县名称", width: 170, align: "center" },
        { prop: "cityCode", label: "地市代码", width: 170, align: "center" },
        { prop: "cityName", label: "地市名称", width: 170, align: "center" },
        { prop: "provinceCode", label: "省级代码", width: 170, align: "center" },
        { prop: "provinceName", label: "省级名称", width: 170, align: "center" },
        { prop: "dataPath", label: "路径", width: "auto", align: "left" }
      ],
      originData: [],
      tableData: [],
